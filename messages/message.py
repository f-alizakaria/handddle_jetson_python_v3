...
class MainMessage(Message):
	...
	DATA_TYPES = {
		...
		2: {'name': 'pressure', 'class': 'default_data_persister'},
		3: {'name': 'door_closed', 'class': 'door_closed_data_persister'},
		4: {'name': 'electric_plug_current', 'class': 'current_data_persister'},
		5: {'name': 'humidity', 'class': 'default_data_persister'},
		6: {'name': 'temperature', 'class': 'temperature_data_persister'},
		7: {'name': 'pm1', 'class': 'default_data_persister'},
		8: {'name': 'pm2_5', 'class': 'default_data_persister'},
		9: {'name': 'pm4', 'class': 'default_data_persister'},
		10: {'name': 'pm10', 'class': 'default_data_persister'},
		11: {'name': 'voc_index', 'class': 'default_data_persister'},
		12: {'name': 'nox_index', 'class': 'default_data_persister'},
		13: {'name': 'humidity_ext', 'class': 'default_data_persister'},
		14: {'name': 'temperature_ext', 'class': 'temperature_data_persister'},
		15: {'name': 'pm1_ext', 'class': 'default_data_persister'},
		16: {'name': 'pm2_5_ext', 'class': 'default_data_persister'},
		17: {'name': 'pm4_ext', 'class': 'default_data_persister'},
		18: {'name': 'pm10_ext', 'class': 'default_data_persister'},
		19: {'name': 'voc_index_ext', 'class': 'default_data_persister'},
		20: {'name': 'nox_index_ext', 'class': 'default_data_persister'},
		21: {'name': 'weight', 'class': 'default_data_persister'},
	}
