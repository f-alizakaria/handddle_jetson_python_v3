...
class MainMessage(Message):
	...
	DATA_TYPES = {
		...
		7: {'name': 'pm1', 'class': 'pm_data_persister'},
		8: {'name': 'pm2_5', 'class': 'pm_data_persister'},
		9: {'name': 'pm4', 'class': 'pm_data_persister'},
		10: {'name': 'pm10', 'class': 'pm_data_persister'},
		...
		15: {'name': 'pm1_ext', 'class': 'pm_data_persister'},
		16: {'name': 'pm2_5_ext', 'class': 'pm_data_persister'},
		17: {'name': 'pm4_ext', 'class': 'pm_data_persister'},
		18: {'name': 'pm10_ext', 'class': 'pm_data_persister'},
